      ...
      <?  /*Menu*/ include_once('includes/menu.php');  ?>
			...
			<div class="video_container">
				<div class="video__box">
					...
					<video  class="is__mobile" src="/SAGA_SAN_mob.mp4" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"' playsinline loop muted autoplay controls></video>
				</div>
				<div class="sound">
      ...
      <div id="place" <?LazyLoad ("/img/main_bg.jpg", array("class"=>"content_2"))?>>
        <div class="content_wrapper clearfix">
					...
					<div class="place__map">
						...
						<img src="/img/bigmap.jpg" alt="Розташування комплексу">
					</div>
            <!-- <div class="big_text"> -->
